...
public class TestZookeeper implements Watcher{
    ...
    public static void main(String[] args) throws Exception {
        ...
        ZooKeeper zookeeper1 =
                new ZooKeeper("112.124.14.16:2181", 5000, new TestZookeeper());
        ...
        ZooKeeper zookeeper2 = new ZooKeeper("112.124.14.16:2181", 5000, new TestZookeeper(),sessionId,sessionPasswd);
        ...
        zookeeper1.create("/node2",
                "123".getBytes(),
                Collections.singletonList(new ACL(ZooDefs.Perms.CREATE, new Id("ip", "112.124.14.16"))),
